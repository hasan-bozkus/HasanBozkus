...
namespace HasanBozkus.ViewComponents.Blog
{
    public class SubscribeEMail : ViewComponent
    {
        ...
        public SubscribeEMail(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.InPageSubscribeEMail = _stringLocalizer["inPage.SubscribeEMail"];
