...
namespace HasanBozkus.ViewComponents.Blog
{
    public class LastAddedPost : ViewComponent
    {
        ...
        public LastAddedPost(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.InPageLastAddedPost = _stringLocalizer["inPage.LastAddedPost"];
