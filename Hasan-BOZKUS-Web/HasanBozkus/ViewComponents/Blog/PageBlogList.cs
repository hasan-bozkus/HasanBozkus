...
{
    public class PageBlogList : ViewComponent
    {
        private readonly IStringLocalizer<Lang> _stringLocalizer;

        readonly RequestLocalizationOptions _localizationOptions;

        public PageBlogList(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.PageBlogList = _stringLocalizer["page.BlogList"];
