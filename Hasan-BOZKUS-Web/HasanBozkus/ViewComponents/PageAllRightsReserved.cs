...
{
    public class PageAllRightsReserved : ViewComponent
    {
        private readonly IStringLocalizer<Lang> _stringLocalizer;

        readonly RequestLocalizationOptions _localizationOptions;

        public PageAllRightsReserved(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.PageAllRightsReserved = _stringLocalizer["page.AllRightsReserved"];
