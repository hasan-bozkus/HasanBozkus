...
{
    public class PageOurSocialMediaAccounts : ViewComponent
    {
        private readonly IStringLocalizer<Lang> _stringLocalizer;

        readonly RequestLocalizationOptions _localizationOptions;

        public PageOurSocialMediaAccounts(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.PageOurSocialMediaAccounts = _stringLocalizer["page.OurSocialMediaAccounts"];
