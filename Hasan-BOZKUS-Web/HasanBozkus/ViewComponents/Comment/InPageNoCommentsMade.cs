...
{
    public class InPageNoCommentsMade : ViewComponent
    {
        private readonly IStringLocalizer<Lang> _stringLocalizer;

        readonly RequestLocalizationOptions _localizationOptions;

        public InPageNoCommentsMade(IStringLocalizer<Lang> stringLocalizer, IOptions<RequestLocalizationOptions> localizationOptions)
        {
        ...
        {
            ViewBag.InPageNoCommentsMade = _stringLocalizer["inPage.NoCommentsMade"];
            ViewBag.InPageComments = _stringLocalizer["inPage.Comments"];
